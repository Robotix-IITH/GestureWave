...
public class MainActivity extends FragmentActivity
    ...
    private static long START_TIME_IN_MILLIS; //60s
...
//        mRot = mSensorManager.getDefaultSensor(Sensor.TYPE_ROTATION_VECTOR);
        ...
        String[] items2 = new String[]{"6 sec ", "8 sec", "10 sec"};
        String[] items3 = new String[]{"hi","bye","absent","away","back","testing"};
...
//            }
            ...
            try {
                data1.put("gesture_name", activityInput);
            } catch (JSONException e) {
                e.printStackTrace();
            }
//            if(temp < 1) {
